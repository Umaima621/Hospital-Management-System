...
// Full patient record — includes consultant staff_no AND specialty
// CONSULTANT table has no name column, so we show staff_no + specialty
$sql = "
    SELECT
        P.patient_no,
